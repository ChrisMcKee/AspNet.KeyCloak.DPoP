...
public class MessageReceivedHandlerTests
{
    ...
    public async Task HandleAllowedMode_When_Bearer_With_DPoP_Proof_Should_Fail_With_InvalidToken()
    {
        ...
        httpContext.Request.Headers.Append(KeyCloakConstants.DPoP.ProofHeader, "proof-token");
        ...
        context.HttpContext.Items[KeyCloakConstants.DPoP.BearerErrorCode].Should().Be(KeyCloakConstants.DPoP.Error.Code.InvalidToken);
        context.HttpContext.Items[KeyCloakConstants.DPoP.BearerErrorDescription].Should().Be(KeyCloakConstants.DPoP.Error.Description.BearerSchemeWithDPoPProof);
        context.HttpContext.Items[KeyCloakConstants.DPoP.BearerStatusCode].Should().Be(HttpStatusCode.Unauthorized);
        context.Result.Should().NotBeNull();
        context.Result!.Failure.Should().NotBeNull();
    }
    ...
    public async Task HandleAllowedMode_When_Valid_DPoP_Request_Should_Extract_And_Set_Token()
    {
        ...
        httpContext.Request.Headers.Append(KeyCloakConstants.DPoP.ProofHeader, "valid-proof-token");
