# KeyCloak ASP.NET Core API - Code Examples

This document provides practical, copy-pastable code examples for common scenarios when using the KeyCloak ASP.NET Core API Authentication SDK.
