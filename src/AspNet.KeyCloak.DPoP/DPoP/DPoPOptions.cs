...
{
    private int _iatOffset = KeyCloakConstants.DPoP.IatOffsetDefault;
    private int _leeway = KeyCloakConstants.DPoP.LeewayDefault;
    ...
    internal TokenValidationParameters TokenValidationParameters { get; } = new()
    {
        ...
        ValidTypes = [KeyCloakConstants.DPoP.JwtTyp],
