...
public abstract class DPoPEventHandlerBase
{
    ...
    internal virtual string ExtractTokenFromAuthorizationHeader(string? authorizationHeader)
    {
        ...
        return authorizationHeader[KeyCloakConstants.DPoP.AuthenticationScheme.Length..].Trim();
    }
    ...
    ///     <see cref="KeyCloakConstants.DPoP.AuthenticationScheme" />.
    /// </summary>
    ...
    internal virtual bool IsDPoPScheme(HttpRequest httpRequest)
    {
        ...
        return authorizationHeader != null &&
               authorizationHeader.StartsWith(KeyCloakConstants.DPoP.AuthenticationScheme,
    ...
    internal virtual bool IsDPoPProofHeaderExists(HttpRequest httpRequest)
    {
        var dPoPProofHeaders = httpRequest.Headers
            .Where(h => string.Equals(
                h.Key, KeyCloakConstants.DPoP.ProofHeader, StringComparison.OrdinalIgnoreCase))
            .ToList();
    ...
    internal bool IsAuthorizationTokenExists(HttpRequest httpRequest)
    {
        ...
        else if (authorizationHeader.StartsWith(KeyCloakConstants.DPoP.AuthenticationScheme,
                     StringComparison.OrdinalIgnoreCase))
        {
            return authorizationHeader[KeyCloakConstants.DPoP.AuthenticationScheme.Length..].Trim().Length > 0;
        }
    ...
    internal void HandleInvalidRequestInAllowedMode(ResultContext<JwtBearerOptions> context)
    {
        ...
        context.HttpContext.Items[KeyCloakConstants.DPoP.BearerStatusCode] = HttpStatusCode.BadRequest;
        context.Fail(KeyCloakConstants.DPoP.Error.Code.InvalidRequest);
    }
    ...
    internal void HandleInvalidRequestInRequiredMode(ResultContext<JwtBearerOptions> context)
    {
        context.HttpContext.Items[KeyCloakConstants.DPoP.DPoPErrorCode] =
            KeyCloakConstants.DPoP.Error.Code.InvalidRequest;
        context.HttpContext.Items[KeyCloakConstants.DPoP.DPoPStatusCode] = HttpStatusCode.BadRequest;
        context.Fail(KeyCloakConstants.DPoP.Error.Code.InvalidRequest);
    }
}
