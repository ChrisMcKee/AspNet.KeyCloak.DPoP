...
{
    private static readonly string DefaultDPoPHeader = $"DPoP {KeyCloakConstants.DPoP.Error.DefaultDPoPAlgs}";
    ...
    internal virtual Task HandleAllowedMode(JwtBearerChallengeContext context)
    {
        ...
        context.Response.Headers.Append(KeyCloakConstants.DPoP.WWWAuthenticateHeader, DefaultDPoPHeader);
    ...
    internal void BuildBearerAuthenticateHeader(JwtBearerChallengeContext context)
    {
        var headerConfig = new AuthenticateHeaderConfig(
            KeyCloakConstants.DPoP.Error.BearerScheme,
    ...
    {
        var headerConfig = new AuthenticateHeaderConfig(
            KeyCloakConstants.DPoP.Error.DPoPScheme,
    ...
    internal virtual void BuildAuthenticateHeader(JwtBearerChallengeContext context, AuthenticateHeaderConfig config)
    {
            ...
            string.IsNullOrWhiteSpace(errorDescription?.ToString()))
        {
            ...
            sb.Append(' ').Append(KeyCloakConstants.DPoP.Error.DefaultRealm);
        }

        context.Response.Headers.Append(KeyCloakConstants.DPoP.WWWAuthenticateHeader, sb.ToString());
