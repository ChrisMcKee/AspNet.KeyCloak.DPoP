...
public static class AuthenticationBuilderExtensions
{
    ...
    public static KeyCloakApiAuthenticationBuilder AddKeyCloakApiAuthentication(
        this AuthenticationBuilder builder, Action<KeyCloakApiOptions>? configureOptions)
    {
    ...
    /// </returns>
    public static KeyCloakApiAuthenticationBuilder AddKeyCloakApiAuthentication(
        this AuthenticationBuilder builder, string authenticationScheme, Action<KeyCloakApiOptions>? configureOptions)
    {
    ...
    /// </returns>
    public static KeyCloakApiAuthenticationBuilder WithDPoP(
        this KeyCloakApiAuthenticationBuilder builder)
    {
